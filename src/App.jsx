...
function App() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 px-4">
      <form onSubmit={handleSubmit} className="w-full max-w-md bg-gray-200 rounded-2xl shadow-lg p-6 relative">
        ...
        {/* Special Requests */}
        <div className="mb-6">
          <label htmlFor="requests" className="block text-gray-700 mb-1">Special Requests</label>
          <input
            id="requests"
            type="text"
